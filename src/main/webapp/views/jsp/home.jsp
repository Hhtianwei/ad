    ...
    <div class="easyui-accordion" data-options="border:false,fit:true">
        ...
        <div title="广告管理" data-options="iconCls:'icon-bricks'" style="padding:5px;">
            <ul class="easyui-tree wu-side-tree">
                <li iconCls="icon-chart-organisation"><a href="javascript:void(0)" id="items" data-icon="icon-chart-organisation" iframe="0">项目列表</a></li>
                <li iconCls="icon-users"><a href="javascript:void(0)" id="orders" data-icon="icon-users"  iframe="0">订单列表</a></li>
            </ul>
        </div>
...
<div id="win" class="easyui-window" title="My Window" style="width:300px;height:200px"
    ...
    <a href="#" class="icon-add" id="sure">确认生成</a>
</div>
